 ...
 * @author henrichen
 */
public class Book08XlsCopyTest {
	...
	public void testCopyCell() {
		...
		//Copy cell (C3 -> D4)
		BookHelper.copyCell(cellC3, sheet1, 3, 3, XRange.PASTE_ALL, XRange.PASTEOP_NONE, false);
	...
	public void testCopyCellRefError2() {
		...
		//Copy cell (C3 -> C2)
		BookHelper.copyCell(cellC3, sheet1, 1, 2, XRange.PASTE_ALL, XRange.PASTEOP_NONE, false);
		_evaluator.notifySetFormula(cellC3);
	...
	public void testCopyCellRefError3() {
		...
		//Copy cell (D3 -> IV3)
		BookHelper.copyCell(cellD3, sheet1, 2, 255, XRange.PASTE_ALL, XRange.PASTEOP_NONE, false);
