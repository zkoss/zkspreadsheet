 ...
 * @author henrichen
 */
public class Book14XlsxTextFormatTest {
	...
	private void testOneRow(Row row) {
		...
		XFormatText a = BookHelper.getFormatText(cellA);
		...
		XFormatText b = BookHelper.getFormatText(cellB);
	...
	private void testZero(Row row, int colindex, String expect) {
		...
		XFormatText c = BookHelper.getFormatText(cell);
