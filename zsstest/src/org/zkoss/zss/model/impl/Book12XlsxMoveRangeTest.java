 ...
 * @author henrichen
 */
public class Book12XlsxMoveRangeTest {
	...
	public void setUp() throws Exception {
		final String filename = "Book12.xlsx";
	...
	public void testMoveC6F8_C7F9() { //bottom side move down 
		...
		assertNull(row6.getCell(2)); //C6;
		assertNull(row6.getCell(3)); //D6;
		assertNull(row6.getCell(4)); //E6;
		assertNull(row6.getCell(5)); //F6;
