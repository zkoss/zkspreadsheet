...
public class ModelInternalEvents {
	...
	public static ModelInternalEvent createModelInternalEvent(String name, NBook book,Object... data){
		return createModelInternalEvent(name,book,null,data);
	}
	public static ModelInternalEvent createModelInternalEvent(String name, NSheet sheet, Object... data){
		return createModelInternalEvent(name,sheet.getBook(),sheet,data);
	}
	public static ModelInternalEvent createModelInternalEvent(String name, NBook book, NSheet sheet,Object... data){
