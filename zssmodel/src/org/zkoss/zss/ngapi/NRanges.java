...
public class NRanges {
	/** 
	 * Returns the associated {@link NRange} of the whole specified {@link SSheet}. 
	 *  
	 * @param sheet the {@link SSheet} the Range will refer to.
	 * @return the associated {@link NRange} of the whole specified {@link SSheet}. 
	 */
	public static NRange range(SSheet sheet){
		return new NRangeImpl(sheet);
	}
	
	/** Returns the associated {@link NRange} of the specified {@link SSheet} and area reference string (e.g. "A1:D4" or "NSheet2!A1:D4")
	 ...
	 * @return the associated {@link NRange} of the specified {@link SSheet} and area reference string (e.g. "A1:D4"). 
	 */
	public static NRange range(SSheet sheet, String areaReference){
	 ...
	 */
	public static NRange rangeByName(SSheet sheet, String name){
	 ...
	 * @return the associated {@link NRange} of the specified {@link SSheet} and area.
	 */
	public static NRange range(SSheet sheet, int tRow, int lCol, int bRow, int rCol){
		return new NRangeImpl(sheet,tRow,lCol,bRow,rCol);
	}
	
	/** Returns the associated {@link NRange} of the specified {@link SSheet} and cell row and column. 
	 *  
	 * @param sheet the {@link SSheet} the Range will refer to.
	 * @param row row index of the cell the Range will refer to.
	 * @param col column index of the cell the Range will refer to.
	 * @return the associated {@link NRange} of the specified {@link SSheet} and cell . 
	 */
	public static NRange range(SSheet sheet, int row, int col){	
