...
public class CellBorderAction extends AbstractCellStyleAction {
	...
	private final int _rRow,_rColumn,_rlRow,_rlColumn;
	...
	public CellBorderAction(String label, Sheet sheet, int row, int column,
		...
		_rRow = _row>0?_row-1:_row;
		_rColumn = _column>0?_column-1:_column;
		_rlRow = lastRow<book.getMaxRows()-1?lastRow+1:lastRow;
		_rlColumn = lastColumn<book.getMaxColumns()-1?lastColumn+1:lastColumn;
	}
