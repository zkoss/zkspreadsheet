...
public class SSWorkbookCtrl implements WorkbookCtrl {
	...
	public void insertColumnLeft() {
		...
		CellOperationUtil.insert(r.toColumnRange(), InsertShift.RIGHT, InsertCopyOrigin.FORMAT_RIGHT_BELOW);
...
//				rect.getLeft(), rect.getRight());
	...
	public void insertRowAbove() {
		Range r = Ranges.range(spreadsheet.getSelectedSheet(), SheetHelper.getVisibleSelection(spreadsheet));
		CellOperationUtil.insert(r.toRowRange(), InsertShift.DOWN, InsertCopyOrigin.FORMAT_LEFT_ABOVE);
...
//		}
	...
	public void hide(boolean hide) {
		...
		Ranges.range(spreadsheet.getSelectedSheet(),rect).setHidden(hide);
	}
...
//	}
	...
	public void addChart(int row, int col, Chart.Type chartType) {
		Sheet sheet = spreadsheet.getSelectedSheet();
		...
		ChartData data = ChartDataUtil.getChartData(sheet,selection, chartType);
		
		range.addChart(anchor, data, chartType, Chart.Grouping.STANDARD, Chart.LegendPosition.RIGHT);
	}
