 ...
 * @author henrichen
 */
public class Book04XlsInsertRowsTest {
	...
	public void setUp() throws Exception {
		final String filename = "Book4.xls";
	...
	public void testInsertRow5() {
		...
		//Insert row 5
		BookHelper.insertRows(sheet1, 4, 1, XRange.FORMAT_LEFTABOVE);
	...
	public void testInsertA5_D5() {
		...
		//Insert A5:D5
		BookHelper.insertRange(sheet1, 4, 0, 4, 3, false, XRange.FORMAT_LEFTABOVE);
		_evaluator.notifySetFormula(cellC1);
