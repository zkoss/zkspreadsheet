 ...
 * @author henrichen
 */
public class Book09XlsxSortTest {
	...
	public void setUp() throws Exception {
		final String filename = "Book9.xlsx";
	...
	public void testSortByColumns() {
		...
		//Sort A1:C12
		ChangeInfo info = BookHelper.sort(sheet1, 0, 0, 11, 2, ((XRangeImpl)XRanges.range(sheet1, 0, 0)).getRefs().iterator().next(), false, 
	...
	public void testSortByRows() {
		...
		//Sort A15:L17
		ChangeInfo info = BookHelper.sort(sheet1, 14, 0, 16, 11, ((XRangeImpl)XRanges.range(sheet1, 14, 0)).getRefs().iterator().next(), false, 
