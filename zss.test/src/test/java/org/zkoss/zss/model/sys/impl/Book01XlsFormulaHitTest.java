 ...
 *
 */
public class Book01XlsFormulaHitTest {
	private XBook _book;
	...
	public void setUp() throws Exception {
		...
		_evaluator = ((XBook)_book).getFormulaEvaluator();
	...
	public void testEvaluateArea() {
		XSheet sheet1 = _book.getWorksheet("Sheet 1");
		...
		Set<Ref>[] refs = new XRangeImpl(0, 0, sheet1, sheet1).setValue(2); //A1 = 2
	...
	public void testEvaluateExternArea() {
		XSheet sheet1 = _book.getWorksheet("Sheet 1");
		XSheet sheet2 = _book.getWorksheet("Sheet2");
		...
		Set<Ref>[] refs = new XRangeImpl(1, 0, sheet2, sheet2).setValue(2); //Sheet2!A2 = 2
		Set<Ref> dependents = refs[0]; 
	...
	public void testEvaluateArea3D() {
		XSheet sheet1 = _book.getWorksheet("Sheet 1");
		XSheet sheet2 = _book.getWorksheet("Sheet2");
		XSheet sheet3 = _book.getWorksheet("Sheet3");
		...
		Set<Ref>[] refs = new XRangeImpl(2, 0, sheet1, sheet1).setValue(2); //Sheet1!A3 = 2
		Set<Ref> dependents = refs[0]; 
	...
	public void testEvaluateExternRef() {
		...
		Set<Ref>[] refs = new XRangeImpl(3, 0, sheet2, sheet2).setValue(2); //Sheet2!A4 = 2
		Set<Ref> dependents = refs[0]; 
	...
	public void testEvaluateRef3D() {
		...
		Set<Ref>[] refs = new XRangeImpl(4, 0, sheet1, sheet1).setValue(2); //Sheet1!A5 = 2
		Set<Ref> dependents = refs[0]; 
