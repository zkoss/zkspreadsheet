...
public class Issue829Test {
	 ...
	 */
	@Test
	public void exportIllegalRegion() {
		Book book = Util.loadBook(this, "book/829-chart-illegal-region-pdf.xlsx");
		
		File temp = Setup.getTempFile("Issue829IllegalRegionTest",".pdf");
