...
public class Issue831Test {
	 ...
	 */
	@Test
	public void exportClippedChart() {
		Book book = Util.loadBook(this, "book/831-chart-clipping-pdf.xlsx");
		
		File temp = Setup.getTempFile("Issue831ChartClipping",".pdf");
