...
public class Issue779Test {
	 ...
	 */
	@Test
	public void exportCenterSelection() {
		Book book = Util.loadBook(this, "book/779-center-selection-pdf.xlsx");
		
		File temp = Setup.getTempFile("Issue779CenterSelectionTest",".pdf");
