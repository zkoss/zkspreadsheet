...
public class Issue1031Test {
	...
	public void exportRepeatRowTitles() {
		Book book = Util.loadBook(this, "book/1031-repeat-row-titles-pdf.xlsx");
		
		File temp = Setup.getTempFile("Issue1031ExportRepeatRowTitles",".pdf");
