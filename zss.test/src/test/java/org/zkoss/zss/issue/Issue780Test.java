...
public class Issue780Test {
	 ...
	 */
	@Test
	public void exportFillBackground() {
		Book book = Util.loadBook(this, "book/780-fill-background-pdf.xlsx");
		
		File temp = Setup.getTempFile("Issue780FillBackgroundTest",".pdf");
