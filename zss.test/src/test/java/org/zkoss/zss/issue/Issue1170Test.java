...
public class Issue1170Test {
	 ...
	 */
	@Test
	public void exportHiddenColumnCD() {
		Book book = Util.loadBook(this, "book/1170-hidden-pdf.xlsx");
		
		File temp = Setup.getTempFile("Issue1170HiddenTest",".pdf");
