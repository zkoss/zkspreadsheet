...
public class Issue1074Test {
	 ...
	 */
	@Test
	public void exportRowBackcolor() {
		Book book = Util.loadBook(this, "book/1074-row-backcolor-pdf.xlsx");
		
		File temp = Setup.getTempFile("Issue1074RowBackcolorTest",".pdf");
