...
public class Issue1010Test {
	...
	public void testExportXlsBookWithPrintArea() throws IOException {
		...
		try  {
			Book book = Util.loadBook(this, "book/1010-export-IOOBE.xlsx");
...
//			Filedownload.save(os.toByteArray(), "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "scale0.xlsx"); 
			...
			Assert.assertTrue("Exception when load \"issue/book/1010-export-IOOBE.xls\":\n" + e, false);
		} finally {
			 os.close();
		}
	}
