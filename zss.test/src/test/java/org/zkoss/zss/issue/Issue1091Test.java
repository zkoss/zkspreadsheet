...
public class Issue1091Test {
	 ...
	 */
	@Test
	public void exportCustomHeaderFooter() {
		Book book = Util.loadBook(this, "book/1091-custom-header-footer-pdf.xlsx");
		
		File temp = Setup.getTempFile("Issue1091CustomHeaderFooterTest",".pdf");
