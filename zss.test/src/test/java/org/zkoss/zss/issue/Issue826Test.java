...
public class Issue826Test {
	
	@BeforeClass
	public static void setUpLibrary() throws Exception {
		Setup.touch();
		Library.setProperty("org.zkoss.zss.chart.title.font", "sansserif, bold, 30");
	}
	...
	public void exportTitleFont() {
		Book book = Util.loadBook(this, "book/826-npe-chart-pdf.xlsx");
		
		File temp = Setup.getTempFile("Issue826ExportTitleFontTest",".pdf");
