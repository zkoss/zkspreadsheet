...
public class Issue434Test {
	...
	public void testBlank_InsertRow() throws IOException {
		testBlank_InsertRow1(Util.loadBook("book/blank.xlsx"));
		testBlank_InsertRow2(Util.loadBook("book/blank.xlsx"));
		testBlank_InsertRow1(Util.loadBook("book/blank.xls"));
		testBlank_InsertRow2(Util.loadBook("book/blank.xls"));
	}
	...
	public void testCase1_InsertRow() throws IOException {
		testCase1_InsertRow1(Util.loadBook("book/434-case1.xlsx"));
		testCase1_InsertRow1(mergeForCase1(Util.loadBook("book/blank.xlsx")));
		testCase1_InsertRow1(Util.loadBook("book/434-case1.xls"));
		testCase1_InsertRow1(mergeForCase1(Util.loadBook("book/blank.xls")));
	}
	...
	public void testBlank_DeleteRow() throws IOException {
		testBlank_DeleteRow1(Util.loadBook("book/blank.xlsx"));
		testBlank_DeleteRow2(Util.loadBook("book/blank.xlsx"));
		testBlank_DeleteRow1(Util.loadBook("book/blank.xls"));
		testBlank_DeleteRow2(Util.loadBook("book/blank.xls"));
	}
	...
	public void testCase1_DeleteRow() throws IOException {
		testCase1_DeleteRow1(Util.loadBook("book/434-case1.xlsx"));
		testCase1_DeleteRow1(mergeForCase1(Util.loadBook("book/blank.xlsx")));
		testCase1_DeleteRow1(Util.loadBook("book/434-case1.xls"));
		testCase1_DeleteRow1(mergeForCase1(Util.loadBook("book/blank.xls")));
	}
	private void testCase1_DeleteRow1(Book book) throws IOException {
		...
		assertMeregedRegion(new String[]{"B2:D4","K2:M4","B8:D10","K8:M10"}, sheet);
		
		Ranges.range(sheet,"A9").toRowRange().delete(Range.DeleteShift.UP);
		assertMeregedRegion(new String[]{"B2:D4","K2:M4","B8:D9","K8:M9"}, sheet);
		
		Ranges.range(sheet,"A8").toRowRange().delete(Range.DeleteShift.UP);
		assertMeregedRegion(new String[]{"B2:D4","K2:M4","B8:D8","K8:M8"}, sheet);
	...
	public void testBlank_InserColumn() throws IOException {
		testBlank_InserColumn1(Util.loadBook("book/blank.xlsx"));
		testBlank_InserColumn2(Util.loadBook("book/blank.xlsx"));
		testBlank_InserColumn1(Util.loadBook("book/blank.xls"));
		testBlank_InserColumn2(Util.loadBook("book/blank.xls"));
	}
	...
	public void testBlank_DeleteColumn() throws IOException {
		testBlank_DeleteColumn1(Util.loadBook("book/blank.xlsx"));
		testBlank_DeleteColumn2(Util.loadBook("book/blank.xlsx"));
		testBlank_DeleteColumn1(Util.loadBook("book/blank.xls"));
		testBlank_DeleteColumn2(Util.loadBook("book/blank.xls"));
	}
	...
	public void testCase1_InsertColumn() throws IOException {
		testCase1_InsertColumn1(Util.loadBook("book/434-case1.xlsx"));
		testCase1_InsertColumn1(mergeForCase1(Util.loadBook("book/blank.xlsx")));
		testCase1_InsertColumn1(Util.loadBook("book/434-case1.xls"));
		testCase1_InsertColumn1(mergeForCase1(Util.loadBook("book/blank.xls")));
	}
	...
	public void testCase1_DeleteColumn() throws IOException {
		testCase1_DeleteColumn1(Util.loadBook("book/434-case1.xlsx"));
		testCase1_DeleteColumn1(mergeForCase1(Util.loadBook("book/blank.xlsx")));
		testCase1_DeleteColumn1(Util.loadBook("book/434-case1.xls"));
		testCase1_DeleteColumn1(mergeForCase1(Util.loadBook("book/blank.xls")));
	}
	...
	private void testCase1_DeleteColumn1(Book book) throws IOException {
		...
		assertMeregedRegion(new String[]{"B2:D4","I2:K4","B10:D12","I10:K12"}, sheet);
		
		Ranges.range(sheet,"J1").toColumnRange().delete(Range.DeleteShift.LEFT);
		assertMeregedRegion(new String[]{"B2:D4","I2:J4","B10:D12","I10:J12"}, sheet);
		
		Ranges.range(sheet,"I1").toColumnRange().delete(Range.DeleteShift.LEFT);
		assertMeregedRegion(new String[]{"B2:D4","I2:I4","B10:D12","I10:I12"}, sheet);		
		//export and test again
		File temp = Setup.getTempFile();
		Exporters.getExporter().export(book, temp);
		book = Importers.getImporter().imports(temp, "test");
	...
	public void testCase1_InsertRange() throws IOException {
		testCase1_InsertRange1(Util.loadBook("book/434-case1.xlsx"));
		testCase1_InsertRange1(mergeForCase1(Util.loadBook("book/blank.xlsx")));
		testCase1_InsertRange1(Util.loadBook("book/434-case1.xls"));
		testCase1_InsertRange1(mergeForCase1(Util.loadBook("book/blank.xls")));
	}
	private void testCase1_InsertRange1(Book book) throws IOException {
		...
		assertMeregedRegion(new String[]{"B2:D4","L2:N4","B10:D12","K10:M12"}, sheet);
		
		Ranges.range(sheet,"G1:H13").insert(Range.InsertShift.RIGHT,Range.InsertCopyOrigin.FORMAT_RIGHT_BELOW);
		assertMeregedRegion(new String[]{"B2:D4","N2:P4","B10:D12","M10:O12"}, sheet);
		...
		assertMeregedRegion(new String[]{"B2:D4","N2:P4","B11:D13","M10:O12"}, sheet);
	...
	public void testCase1_DeleteRange() throws IOException {
		testCase1_DeleteRange1(Util.loadBook("book/434-case1.xlsx"));
		testCase1_DeleteRange1(mergeForCase1(Util.loadBook("book/blank.xlsx")));
		testCase1_DeleteRange1(Util.loadBook("book/434-case1.xls"));
		testCase1_DeleteRange1(mergeForCase1(Util.loadBook("book/blank.xls")));
	}
...
//		
	...
	public void testBlank_MoveRange() throws IOException {
		testBlank_MoveRange(Util.loadBook("book/blank.xlsx"));
		testBlank_MoveRange(Util.loadBook("book/blank.xls"));
	}
	private void testBlank_MoveRange(Book book) throws IOException {
		...
		Ranges.range(sheet,"B2:D4").merge(false);
		assertMeregedRegion(new String[]{"B2:D4"}, sheet);
		
		
		Ranges.range(sheet,"B1:D5").shift(1, 1);
		assertMeregedRegion(new String[]{"C3:E5"}, sheet);
		
		Ranges.range(sheet,"B1:F7").shift(2, 2);
		assertMeregedRegion(new String[]{"E5:G7"}, sheet);
	...
	public void testCase1_MoveRange() throws IOException {
		...
		testCase1_MoveRange1(Util.loadBook("book/434-case1.xlsx"));
		testCase1_MoveRange1(mergeForCase1(Util.loadBook("book/blank.xlsx")));
		testCase1_MoveRange1(Util.loadBook("book/434-case1.xls"));
		testCase1_MoveRange1(mergeForCase1(Util.loadBook("book/blank.xls")));
		
		testCase1_MoveRange2(Util.loadBook("book/434-case1.xlsx"));
		testCase1_MoveRange2(mergeForCase1(Util.loadBook("book/blank.xlsx")));
		testCase1_MoveRange2(Util.loadBook("book/434-case1.xls"));
		testCase1_MoveRange2(mergeForCase1(Util.loadBook("book/blank.xls")));
	}
	private void testCase1_MoveRange1(Book book) throws IOException {
		...
		Ranges.range(sheet,"B1:D5").shift(1, 1);
		assertMeregedRegion(new String[]{"C3:E5","K2:M4","B10:D12","K10:M12"}, sheet);
		
		Ranges.range(sheet,"B1:F7").shift(2, 2);
		assertMeregedRegion(new String[]{"E5:G7","K2:M4","B10:D12","K10:M12"}, sheet);
	...
	private void testCase1_MoveRange2(Book book) throws IOException {
		...
		assertMeregedRegion(new String[]{"B2:D4","K2:M4","B10:D12","L11:N13"}, sheet);
		
		Ranges.range(sheet,"K10:O14").shift(2, 2);
		assertMeregedRegion(new String[]{"B2:D4","K2:M4","B10:D12","N13:P15"}, sheet);
	...
	void assertMeregedRegion(String[] regions,Sheet sheet){
